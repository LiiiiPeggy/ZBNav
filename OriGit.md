...
### 1. [cmu_planner/src/local_planner/launch/local_planner.launch](cmu_planner/src/local_planner/launch/local_planner.launch)
...
### 2. [cmu_planner/src/local_planner/src/localPlanner.cpp](cmu_planner/src/local_planner/src/localPlanner.cpp)
...
### 3. [cmu_planner/src/local_planner/src/pathFollower.cpp](cmu_planner/src/local_planner/src/pathFollower.cpp)
...
### 4. [cmu_planner/src/vehicle_simulator/CMakeLists.txt](cmu_planner/src/vehicle_simulator/CMakeLists.txt)
...
### 5. [cmu_planner/src/vehicle_simulator/launch/system_indoor.launch](cmu_planner/src/vehicle_simulator/launch/system_indoor.launch)
...
### 6. [cmu_planner/src/vehicle_simulator/launch/vehicle_simulator.launch](cmu_planner/src/vehicle_simulator/launch/vehicle_simulator.launch)
...
### 7. [cmu_planner/src/vehicle_simulator/src/vehicleSimulator.cpp](cmu_planner/src/vehicle_simulator/src/vehicleSimulator.cpp)
...
### 1. [cmu_planner/README_sim.md](cmu_planner/README_sim.md)

导航仿真指南文档，内容包括：
- 环境要求（Ubuntu 22.04, ROS2 Humble, GCC 11+）
- 依赖安装说明（gazebo-ros, joy）
- 构建步骤（cmu_planner + farplanner_ws）
- 运行指南（多终端启动、launch 参数表）
- 话题数据流图
- 故障排查表

### 2. [cmu_planner/src/vehicle_simulator/launch/vehicle_simulator_adapter.launch](cmu_planner/src/vehicle_simulator/launch/vehicle_simulator_adapter.launch)
...
### 3. [cmu_planner/src/vehicle_simulator/src/vehicleSimulatorAdapter.cpp](cmu_planner/src/vehicle_simulator/src/vehicleSimulatorAdapter.cpp)
