...
: ${AMENT_CURRENT_PREFIX:="/root/work/wyx/lqp/Codes/rs_converter_ws/install/rs_converter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rs_converter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rs_converter/environment/path.sh"
